...
[![Go.Dev reference](https://img.shields.io/badge/go.dev-reference-blue?logo=go&logoColor=white)](https://pkg.go.dev/github.com/zhaozhihom/gen?tab=doc)
...
```bash
go get -u github.com/zhaozhihom/gen
```

2. 在工程中导入引用 Gen:

```go
import "github.com/zhaozhihom/gen"
```
...
```go
import "github.com/zhaozhihom/gen/field"
